/* eslint-disable */
// Generated by Wrangler by running `wrangler types worker-configuration.d.ts` (hash: 6130179be09385cb397f6a715953e2bc)
...
declare namespace Cloudflare {
	interface GlobalProps {
		...
		durableNamespaces: "ThinkChessAgent" | "VanillaChessAgent";
	}
	interface Env {
		AI: Ai;
		VanillaChessAgent: DurableObjectNamespace<import("./src/server/index").VanillaChessAgent>;
		ThinkChessAgent: DurableObjectNamespace<import("./src/server/index").ThinkChessAgent>;
	}
}
