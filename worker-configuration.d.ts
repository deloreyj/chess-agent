/* eslint-disable */
// Generated by Wrangler by running `wrangler types worker-configuration.d.ts` (hash: b42e39d230a3a84866ad8602fefd1a0d)
...
declare namespace Cloudflare {
	interface GlobalProps {
		...
		durableNamespaces: "AgentChessAgent" | "HarnessChessAgent" | "SystemDirectorAgent" | "SystemPlayerAgent";
	}
	interface Env {
		AI: Ai;
		AgentChessAgent: DurableObjectNamespace<import("./src/server/index").AgentChessAgent>;
		HarnessChessAgent: DurableObjectNamespace<import("./src/server/index").HarnessChessAgent>;
		SystemDirectorAgent: DurableObjectNamespace<import("./src/server/index").SystemDirectorAgent>;
		SystemPlayerAgent: DurableObjectNamespace<import("./src/server/index").SystemPlayerAgent>;
	}
}
